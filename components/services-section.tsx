      ...
      <div className="container mx-auto px-4 lg:px-8">
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4 z-20">
                    <span className="text-6xl font-bold text-white/30 group-hover/card:text-primary/40 transition-colors drop-shadow-lg">
                      {service.number}
                    </span>
                  </div>
                </div>
        ...
        {selectedService !== null && (
          <Dialog open={selectedService !== null} onOpenChange={() => setSelectedService(null)}>
            <DialogContent className="max-w-7xl max-h-[92vh] overflow-y-auto p-0" showCloseButton={false}>
              {/* Header con imagen de fondo */}
              <div className="relative h-56 overflow-hidden">
                {/* Botón de cierre personalizado */}
                <button 
                  onClick={() => setSelectedService(null)}
                  className="absolute top-4 right-4 z-20 w-10 h-10 rounded-full bg-white/80 hover:bg-white flex items-center justify-center shadow-md hover:scale-110 transition-all duration-200 cursor-pointer"
